	...
	real*8,parameter :: rhop = 0.d0				!! profilin density in micro-Molar
...
!	real*8,parameter :: rhof = 5.d0				!! formin density in nano-Molar
	...
	real*8,parameter :: factor1=5.d0					!! formin: barbed end growth by only actin (mdia1 - 1) (mdia2 - 0.2)
	...
	real*8,parameter :: kfnuc=0.d0/(vton*vton)				!! formin mediated nucleation from dimer : Zweifel BPJ 2021(2.d-4/(vton*vton))
